# Treasury Management
## Decentralized Fund Allocation — Synergy Network
...
| **Unclaimed Grants** | Returned to treasury after expiration |
...
Real-time dashboard: [https://explorer.synergy-network.io/treasury](https://explorer.synergy-network.io/treasury)
...
- Adjust the percentage of fees routed to treasury.
