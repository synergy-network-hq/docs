...
The Synergy Token (SYN) is the native utility token of the Synergy Network, powering everything from transactions and smart contracts to staking, governance, and reward mechanisms.
...
- Funds disbursed via community proposal and Synergy Score voting
- Treasury audited and monitored on-chain
- Can adjust burn rates, inflation caps, and staking rewards through governance

---

## 8. Pre-Sale Mechanics
