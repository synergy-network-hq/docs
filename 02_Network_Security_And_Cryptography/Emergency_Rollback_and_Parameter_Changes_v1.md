# Emergency Rollback & Parameter Changes
## Emergency Governance Framework — Synergy Network
...
Community-driven emergency voting. Requires:
...
Security and governance auditors review all emergency actions. Required to publish:
- Impact summary.
- Recovery roadmap.
- SP impact for affected validators.

Failure to report may trigger an auditor replacement vote.
