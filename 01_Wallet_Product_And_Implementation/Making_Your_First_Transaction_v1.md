...
Once you've created a Synergy Wallet and obtained SYN tokens, you're ready to make your first transaction. This guide walks you through the process using both the GUI and CLI versions of the Synergy Wallet Tool.
...
You'll be prompted to enter your wallet PIN, confirm the transaction summary, and view the transaction hash after success.
...
- Go to: https://explorer.synergy-network.io
...
- **Stuck transaction:** May occur on congested testnet; recheck later or try with higher fee.
