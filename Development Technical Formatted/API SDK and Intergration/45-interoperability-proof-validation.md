...
- Enables proof of validity without revealing sensitive transaction data.
...
- **Synergy → Ethereum:** `ETHBridge.sol` verifies threshold signature, validates proof root, and releases ERC20 tokens.
- **Synergy → Solana:** `sol_bridge.rs` verifies Synergy-side proof via ABI-compatible interface and executes mint or unlock.
...
- **GitHub:** github.com/synergy-network/bridges
