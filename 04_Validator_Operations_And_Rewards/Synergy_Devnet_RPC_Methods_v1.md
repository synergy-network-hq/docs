...
- `networkId`: Network ID (338638 for devnet)
- `chainId`: Chain ID (338638 for devnet)
...
4. **AIVM Methods**: AIVM (Artificial Intelligence Virtual Machine) methods are currently disabled in the devnet.
