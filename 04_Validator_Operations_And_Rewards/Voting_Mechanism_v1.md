# Voting Mechanism
## Quadratic Voting + Synergy Score — Synergy Network

---

## 1. Overview

Synergy Network utilizes a hybrid voting mechanism combining **Quadratic Voting** and a **Synergy Score Multiplier** to ensure that influence in governance decisions is fairly distributed. This system rewards active participation and reduces the centralizing effect of large token holdings.
...
**Example:** 16 SYN committed, Synergy Score = 1.25 → Final Vote Weight = 4 × 1.25 = **5.0 votes**
...
- Real-time turnout stats and vote impact simulations.
