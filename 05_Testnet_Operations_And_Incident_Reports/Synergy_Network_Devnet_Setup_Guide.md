# Synergy Network Devnet Setup Guide

This guide walks you through setting up and running a node for the Synergy Network Devnet.
...
```bash
git clone https://github.com/hootzluh/synergy-devnet.git
cd synergy-devnet
```
...
- Save logs to `data/logs/devnet.out`

### 5. Stop the Devnet Node
...
- `scripts/` — Start/stop/devnet helper scripts
