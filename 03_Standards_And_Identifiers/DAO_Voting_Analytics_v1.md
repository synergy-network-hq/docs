...
## Report Format & Standards — Synergy Network
...
| Format | Filename | Use |
|---|---|---|
| **JSON** | `dao_analytics_epoch_<N>.json` | Machine processing |
| **PDF** | `dao_analytics_epoch_<N>.pdf` | Human-readable summary |
| **Markdown** | `dao_analytics_epoch_<N>.md` | Version control and archiving |
...
```bash
synergy-cli generate-dao-report
```
