...
## Decentralized Identity & Human-Readable Addresses — Synergy Network
...
- **Governance Profiles:** Displays validator and user reputations alongside names.
...
|---|---|
| **Format** | `username.syn` |
| **Examples** | `justin.syn`, `dao-fund.syn`, `nala.syn` |
| **Uniqueness** | Each name is unique and immutable unless released or expired |
...
Each name is a non-transferable NFT linked to the owner address. Mapped data includes:
...
Type in a `.syn` name to send tokens, stake, or vote.
